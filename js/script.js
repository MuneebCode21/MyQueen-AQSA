/* ==========================================================================
   ...
   This file is organised as:
     ...
     6.  Lightbox
     7.  Scroll reveal
     8.  Custom cursor + magnetic buttons
     9.  Page renderers
     10. Page interactions
     11. Bootstrap
     12. AQSA cinematic art direction
     13. Back to beginning
   ========================================================================== */
...
function applyGirlfriendName(){
  ...
  const name =
    (CONFIG.girlfriendName || "").trim() ||
    "You";

  document
    .querySelectorAll(
      '[data-cfg="girlfriendName"]'
    )
    .forEach(function(el){
...
const MUSIC_PREF_KEY =
  "bday_music_on";


/*
  NEW:
  Once the security question has been answered successfully,
  ...
  root.innerHTML =
    ...
    '<nav class="chrome-nav" data-nav aria-hidden="true">' +
      ...
      '<div class="chrome-nav__inner">' +
        ...
        '<p class="chrome-nav__name">' +
          escapeHTML(CONFIG.girlfriendName) +
        '</p>' +
        ...
        '<ol class="chrome-nav__list">' +
          ...
          CHAPTERS.map(function(c, i){
            ...
            return (
              '<li class="chrome-nav__item' +
              (c.id === currentPage ? " is-current" : "") +
              '">' +
                ...
                '">' +
                  ...
                  '<span class="chrome-nav__index">0' +
                    (i + 1) +
                  '</span>' +
...
function initFooter(){
  ...
  const name =
    (CONFIG.girlfriendName || "Aqsa").trim() ||
    "Aqsa";
    ...
    '<div class="site-footer__top">' +
      ...
      '<div class="site-footer__grid">' +
        ...
        '<div>' +
          ...
          '<div class="site-footer__title" aria-label="' +
            escapeHTML(name) +
          '">' +
        ...
        '<p class="site-footer__dek">' +
          'A little corner of the internet, made one chapter at a time, just for you.' +
        '</p>' +
  ...
  const candidates =
    Array.prototype.slice.call(
      main.querySelectorAll(
        "[data-scroll-section], main > section, .chapters, .story-stop, .page-intro, .final-reveal"
      )
    );
        ...
        function(){
          ...
          showNote({
            ...
            body:
              cfg
                ? cfg.message
                : "PLACEHOLDER — add a message for this discovery in CONFIG.easterEggs."
          });
...
function ensureNoteOverlay(){
  ...
  noteOverlayEl.addEventListener(
    "click",
    function(e){
  ...
  document.addEventListener(
    ...
    function(e){
      ...
      if(
        !noteOverlayEl.classList.contains(
          "is-open"
        )
      ){
        return;
...
function closeNote(){
  ...
  noteOverlayEl.classList.remove(
    "is-open"
  );
  ...
  if(
    noteLastFocused &&
    typeof noteLastFocused.focus === "function"
  ){

    noteLastFocused.focus();
  }
}
...
function closeLightbox(){
  ...
  if(
    lightboxLastFocused &&
    typeof lightboxLastFocused.focus ===
      "function"
  ){
...
function initCustomCursor(){
    ...
    trailDots.forEach(
      function(
        ...
        trailDot.style.transform =
          "translate3d(" +
          trailX[index].toFixed(2) +
          "px," +
          trailY[index].toFixed(2) +
          "px,0) scale(" +
          scale.toFixed(2) +
          ")";
  ...
  const interactiveSelector =
    "a, button, .scrapbook__item, .notes-field__item, .video-slide, .reason-card__face, [role='button']";
...
function renderAboutHer(){
  ...
  if(
    !CONFIG.aboutHer ||
    !CONFIG.aboutHer.length
  ){

    container.innerHTML =
      '<p class="empty-note">Add a few lines to the <code>aboutHer</code> list in js/script.js to fill this section.</p>';
  ...
  container.innerHTML =
    (
      ...
      function(
        ...
        return (
          '<button class="notes-field__item reveal" type="button" style="--i:' +
          i +
          '" data-index="' +
          i +
          '">' +

            '<span class="notes-field__line">' +
...
function renderReasons(){
  ...
  if(
    !CONFIG.reasons ||
    !CONFIG.reasons.length
  ){

    grid.innerHTML =
      '<p class="empty-note">Add a few notes to the <code>reasons</code> list in js/script.js to fill this section.</p>';
    ...
    (
      ...
      function(
        ...
        return (
          ...
          '<div class="reason-card reveal" style="--i:' +
          i +
          '">' +
            ...
            '<div class="reason-card__detail"><p>' +
              escapeHTML(r.detail) +
            '</p></div>' +
...
function renderMemories(){
  ...
  if(!items.length){
    ...
    grid.innerHTML =
      '<p class="empty-note">Add a few photos to the <code>memories</code> list in js/script.js to fill this page.</p>';
    ...
    items.map(
      function(
        ...
        return (
          ...
          '<div class="scrapbook__item reveal" style="--i:' +
          i +
          '">' +
            ...
            '">' +
              ...
              '<div class="media-frame" data-media-frame>' +
                ...
                '<img class="media-frame__media" src="' +
                escapeHTML(item.src) +
                '" alt="' +
                escapeHTML(
                  item.caption ||
                ...
                '<div class="media-frame__empty" aria-hidden="true">' +
                  ...
                  '<span class="media-frame__empty-label">' +
                    escapeHTML(item.src) +
                  '</span>' +
...
function renderVideos(){
  ...
  if(!items.length){
    ...
    feed.innerHTML =
      '<p class="empty-note" style="margin:auto;color:var(--muted-on-dark);">Add a few clips to the <code>videos</code> list in js/script.js to fill this page.</p>';
    ...
    items.map(
      function(
        ...
        return (
          ...
          '<div class="video-slide" data-category="' +
          escapeHTML(
            v.category ||
            "MEMORIES"
          ) +
          ...
          '">' +
            ...
            '<div class="media-frame video-slide__media" data-media-frame>' +
              ...
              '<video class="media-frame__media" src="' +
              escapeHTML(v.src) +
            ...
            '<div class="video-slide__meta">' +
              ...
              '<span class="video-slide__category">' +
                ...
                (
                  v.featured
                    ? ' <span class="video-slide__star">\u2605</span>'
                    : ""
                ) +

              '</span>' +

              '<p class="video-slide__caption">' +
                escapeHTML(
                  v.caption ||
                  ""
                ) +
    ...
    bar.innerHTML =
      cats.map(
        function(
          ...
          return (
            '<button type="button" class="filter-bar__chip' +
            (
              i === 0
                ? " is-active"
                : ""
...
function renderTimeline(){
  ...
  if(!items.length){
    ...
    track.innerHTML =
      '<p class="empty-note">Add a few moments to the <code>timeline</code> list in js/script.js to fill this page.</p>';
  ...
  const EGG_MARKUP =
    '<button type="button" class="egg egg--story" data-egg="egg-story" aria-label="A tiny hidden something"><span aria-hidden="true">\u2726</span></button>';
    ...
    items.map(
      function(
        ...
        return (
          ...
          '<article class="story-stop reveal' +
          (
            isCoda
              ? " story-stop--coda"
              : ""
          ...
          '">' +
            ...
            (
              stop.date
                ? '<p class="story-stop__date">' +
                  escapeHTML(stop.date) +
                  '</p>'
                : ""
            ) +

            '<h3 class="story-stop__title">' +
...
function initGateSequence(
  ...
  const isHomeGate =
    root.matches("[data-gate]") &&
    !root.matches("[data-final-gate]");


  /*
    NEW:
    Check localStorage BEFORE showing the security question.

    First visit:
      securityAlreadyPassed = false

    Every visit after successful answer:
      securityAlreadyPassed = true
  */
  const securityAlreadyPassed =
    isHomeGate &&
    safeGet(
      SECURITY_PASSED_KEY
    ) === "1";
  ...
  if(enterBtn){
    ...
    enterBtn.addEventListener(
      ...
      function(){
        ...
        /*
          SECURITY ONLY ON FIRST SUCCESSFUL VISIT.

          Once localStorage contains "1", the cinematic gate simply
          continues to the website without opening the question.
        */
        if(
          isHomeGate &&
          !root.dataset.securityPassed &&
        ...
        /*
          Already verified:
          skip the security modal completely.
        */
        root.classList.add(
          "is-leaving"
        );
...
function initCountdown(){
  ...
  function render(){
    ...
    if(diff <= 0){
      ...
      el.innerHTML =
        '<p class="countdown__label">it\u2019s today \u2726</p>';
  ...
  button.addEventListener(
    ...
    function(){
      ...
      if(!value){
        ...
        result.innerHTML =
          "<strong>Please choose your date of birth first. ♡</strong>";
      ...
      if(
        ...
        result.innerHTML =
          "<strong>Please choose a valid date. ♡</strong>";
      ...
      if(
        ...
        result.innerHTML =
          "<strong>That birthday hasn't happened yet. ✨</strong>";
...
function initEnvelope(){
  ...
  if(openHint){
    ...
    openHint.addEventListener(
      "click",
      openEnvelope
    );


    openHint.setAttribute(
      "role",
      "button"
    );
...
function applyFinalVideo(){
  ...
  video.setAttribute(
    "aria-label",
    "Birthday video. Click to pause or resume."
  );
  ...
  if(
    !video.dataset.finalToggleReady
  ){
...
/* ========================================================================
   FINAL FLOWERS / STARS / CONFETTI
   ======================================================================== */

function buildFinalGateFloaters(
  gate
){
  ...
  for(
    ...
    floater.className =
      "final-gate-floater final-gate-floater" +
      types[
        i %
        types.length
      ];
...
function initAqsaAtmosphere(){
  ...
  function tick(){
    ...
    document
      .querySelectorAll(
        ".media-frame, .video-slide, .reason-card, .scrapbook__item"
      )
      .forEach(
        function(card){
        ...
        heading.innerHTML =
          words.map(
            function(
              ...
              return (
                '<span class="aqsa-heading-word" style="--i:' +
                i +
                '">' +
                escapeHTML(word) +
                '</span>'
